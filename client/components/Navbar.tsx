    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <a
            href="/"
            className="flex items-center group shrink-0 py-1 transition-transform duration-200"
            aria-label="VCET Hackathon 2026 Home"
          >
            <img
              src="/logo.png"
              alt="VCET Hackathon 2026 Logo"
              className="h-11 sm:h-14 md:h-16 lg:h-18 w-auto object-contain scale-[1.7] md:scale-[2.2] origin-left drop-shadow-[0_0_10px_rgba(255,0,127,0.35)] group-hover:drop-shadow-[0_0_14px_rgba(0,240,255,0.7)] hover:scale-[1.8] md:hover:scale-[2.3] transition-all duration-300"
            />
          </a>
