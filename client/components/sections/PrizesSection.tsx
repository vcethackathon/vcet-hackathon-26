...
const prizes: Prize[] = [
  { rank: '2ND', label: 'HIGH SCORE', amount: '20000', accent: '#D8E1F0', glow: 'rgba(216,225,240,0.52)', icon: 'trophy', art: '/prize-silver-trophy.png', className: 'silver-podium' },
  { rank: '1ST', label: 'BOSS CLEAR', amount: '50000', accent: '#FFD700', glow: 'rgba(255,215,0,0.58)', icon: 'crown', art: '/prize-gold-trophy.png', className: 'champion-podium' },
  { rank: '3RD', label: 'BONUS STAGE', amount: '5000', accent: '#C7854B', glow: 'rgba(199,133,75,0.48)', icon: 'trophy', art: '/prize-bronze-trophy.png', className: 'bronze-podium' },
  { rank: '4TH', label: 'BONUS STAGE', amount: '5000', accent: '#C7854B', glow: 'rgba(199,133,75,0.48)', icon: 'trophy', art: '/prize-bronze-trophy.png', className: 'bronze-podium' },
  { rank: '5TH', label: 'BONUS STAGE', amount: '5000', accent: '#C7854B', glow: 'rgba(199,133,75,0.48)', icon: 'trophy', art: '/prize-bronze-trophy.png', className: 'bronze-podium' },
];
    ...
    <section id="prizes" className="prize-stage">
      ...
      <div className="prize-content">
        ...
        >
          ...
          <strong><span className="rupee">₹</span>85000</strong>
