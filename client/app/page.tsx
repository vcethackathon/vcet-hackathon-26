...
const FAQS = [
  {
    ...
    a: "Any student currently enrolled in an engineering or technology course. Participants can be from any year and any branch.",
  },
  {
    q: "What is the team size?",
    a: "Teams can have 1 to 4 members. We encourage teams of 3-4 for the best collaborative experience.",
  },
  {
    q: "Is there a registration fee?",
    a: "No, participation is completely free! Just register online and get selected.",
  },
  {
    q: "What should I bring?",
    a: "Your laptop, charger, valid college ID, and your most creative ideas. Meals and refreshments will be provided on-site.",
  },
  {
    q: "Will there be mentors?",
    a: "Yes! Industry mentors and expert judges will be present throughout the event to guide your team.",
  },
  {
    q: "What are the judging criteria?",
    a: "Innovation, technical complexity, design & UX, business viability, and the final presentation pitch.",
  },
];
      ...
      try {
        ...
        [
          ...
          g.gain.exponentialRampToValueAtTime(
            0.001,
            ctx.currentTime + (delay as number) + 0.1,
          );
          osc.connect(g);
    ...
    <>
      ...
      <nav className="navbar">
        ...
        <ul className="nav-links">
          {["About", "Tracks", "Prizes", "Timeline", "Sponsors", "FAQ"].map(
            (l) => (
              <li key={l}>
      ...
      <section id="hero" className="hero-section">
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions">
            <button id="register" className="btn-primary" onClick={insertCoin}>
              {coinState === "ready"
                ? "▶ PLAYER 1 READY"
                : "▶ INSERT COIN — JOIN"}
            </button>
        ...
        <div className="about-grid">
          ...
          <div>
            ...
            <p className="section-sub">
              ...
              Information Technology at Vidyavardhini's College of Engineering
              and Technology. We aim to foster a strong programming culture and
              build critical problem-solving skills among students.
            </p>
            <p className="section-sub" style={{ marginTop: "1rem" }}>
              This year's theme is{" "}
              <strong style={{ color: "var(--cyan)" }}>Arcade</strong> —
              blending retro gaming energy with cutting-edge technology to
      ...
      >
        ...
        <p className="section-sub">
          Choose your domain and build a solution that defeats the challenge.
          Six boss arenas. One winner.
        </p>
      ...
      <section id="prizes" className="section">
        <div style={{ textAlign: "center" }}>
          ...
          <p className="section-sub" style={{ margin: "1rem auto 0" }}>
            Compete, build, and claim your loot. Real money, real trophies, real
            recognition.
          </p>
        </div>
      ...
      >
        ...
        <p className="section-sub">
          Four critical levels stand between you and the final boss. Clear each
          one to advance.
        </p>
      ...
      >
        ...
        <p className="section-sub" style={{ margin: "1rem auto 2rem" }}>
          Industry leaders who believe in the next generation of builders.
        </p>
        ...
        <div className="sponsors-tiers">
          ...
          <div>
            ...
            <div className="sponsor-row">
              {["DevHub", "PixelLabs", "ByteForge", "OpenStack Co."].map(
                (s) => (
                  <div key={s} className="sponsor-card">
                    {s}
                  </div>
      ...
      <footer id="contact" className="footer-cta">
        ...
        <p className="cta-sub">
          Registration is free. Spots are limited. Don't let your credit run
          out.
        </p>
        <div
          style={{
        ...
        >
          <a href="#register" className="btn-primary" onClick={insertCoin}>
            ▶ INSERT COIN — JOIN
          </a>
